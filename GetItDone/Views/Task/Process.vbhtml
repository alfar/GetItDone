...
<table class="workflow">
    ...
    <tr><td colspan="3" class="goal">Trash</td><td class="goal">@Html.ActionLink("Project", "CreateProject", New With {.Id = Model.Id, .Name = Model.Title})</td><td class="goal">Calendar</td></tr>
</table>
