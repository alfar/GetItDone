...
Namespace Microsoft.Web.Mvc
    ...
    Public Class MobileCapableRazorViewEngine
        ...
        Public Sub New()
            Me.New("Mobile", Function(context) context.Request.Browser.IsMobileDevice OrElse context.Request.Headers("User-Agent").ToLower().Contains("android"))
        End Sub

        Public Sub New(viewModifier As String)
            Me.New(viewModifier, Function(context) context.Request.Browser.IsMobileDevice OrElse context.Request.Headers("User-Agent").ToLower().Contains("android"))
        End Sub
